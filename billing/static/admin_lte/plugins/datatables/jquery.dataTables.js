...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 *    filtering)
		 *  @param {int} grand_total Total number of rows in the data set, after filtering
		 ...
		 *  @example
		 *    $('#example').dataTable( {
		 *      "infoCallback": function( settings, start, end, max, grand_total, pre ) {
		 *        return start +" to "+ end;
		 *      }
		 *    } );
		 */
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default (filtered from _MAX_ grand_total entries)
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtered from _MAX_ grand_total entries)",
