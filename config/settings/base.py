...
)  # (billing/config/settings/base.py - 3 = billing/)
APPS_DIR = ROOT_DIR.path("billing")
...
LOCAL_APPS = [
    "billing.users.apps.UsersConfig",
    "main",
...
MIGRATION_MODULES = {"sites": "billing.contrib.sites.migrations"}
...
# ------------------------------------------------------------------------------
# Django Admin URL.
ADMIN_URL = "Mohandozadmin/"
# https://docs.djangoproject.com/en/dev/ref/settings/#admins
ADMINS = [("""Mohand Ahmad""", "vaultofpython@outlook.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "billing.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "billing.users.adapters.SocialAccountAdapter"
