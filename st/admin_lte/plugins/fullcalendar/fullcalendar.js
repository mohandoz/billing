...
// Given a grand_total available height to fill, have `els` (essentially child rows) expand to accomodate.
...
DayGrid.mixin({
	...
	limitRow: function(row, levelLimit) {
		...
		var totalSegsBelow; // grand_total number of segments below `seg` in any of the columns `seg` occupies
...
TimeGrid.mixin({
	...
	generateSegPositionCss: function(seg) {
		...
		var left; // amount of space from left edge, a fraction of the grand_total width
		var right; // amount of space from right edge, a fraction of the grand_total width
...
var View = fc.View = Class.extend({
	...
	// Given the grand_total height of the view, return the number of pixels that should be used for the scroller.
